...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/disconnect-command": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "disconnect command info",
                        "name": "message",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/vernemqtt.DisconnectCommand"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/vernemqtt.SubscriptionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "vernemqtt.SubscriptionResponse": {
            "type": "object",
            "properties": {
                "result": {
                    "type": "string",
