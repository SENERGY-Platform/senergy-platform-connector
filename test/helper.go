...
func createDeviceType(conf configuration.Config, managerUrl string, characteristicId string) (typeId string, getServiceTopic string, setServiceTopic string, err error) {
