...
func createDeviceType(conf lib.Config, managerUrl string, characteristicId string) (typeId string, getServiceTopic string, setServiceTopic string, err error) {
...
func createCharacteristic(name string, config lib.Config) (string, error) {
